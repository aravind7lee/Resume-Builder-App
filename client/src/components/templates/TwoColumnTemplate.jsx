    ...
    <div className="max-w-[8.5in] mx-auto bg-white text-gray-900 grid grid-cols-1 md:grid-cols-[35%_65%] print:grid-cols-[35%_65%]" style={{ display: 'grid', gridTemplateColumns: '35% 65%' }}>
      ...
      <aside className="text-white p-6 print:p-4" style={{ backgroundColor: accentColor }}>
        ...
        {data.personal_info?.image && (
          <div className="mb-6">
            <img
              ...
              alt="Profile"
              className="w-32 h-32 rounded-full object-cover border-4 border-white mx-auto print:rounded-full"
        ...
        <section className="mb-6">
          <h2 className="text-sm font-bold uppercase tracking-wide mb-3 pb-2 border-b border-white/30">
            Contact
          </h2>
        ...
        {data.education && data.education.length > 0 && (
          <section className="mb-6">
            <h2 className="text-sm font-bold uppercase tracking-wide mb-3 pb-2 border-b border-white/30 flex items-center gap-2">
      ...
      <main className="p-6 print:p-4">
        ...
        {data.professional_summary && (
          <section className="mb-6">
            <h2 className="text-lg font-bold mb-3 uppercase tracking-wide pb-2 border-b-2" style={{ borderColor: accentColor, color: accentColor }}>
              Profile
            </h2>
